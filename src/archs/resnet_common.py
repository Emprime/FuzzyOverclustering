...
from keras.layers import Conv2D, GlobalMaxPooling2D, GlobalAveragePooling2D, Dense, Activation, BatchNormalization, \
    MaxPooling2D, ZeroPadding2D, Add, DepthwiseConv2D
